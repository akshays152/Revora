...
export function StateTimeline({ laps, selectedLap, onSelectLap }: StateTimelineProps) {
  return (
    <section className="panel timeline-panel">
      <div className="panel-heading"><span className="eyebrow">05 / DRIVER STATE TIMELINE</span><span className="status-text"><Icon name="pulse" size={15} /> LAPS 31—42</span></div>
