...
export function DriverStatePanel({ lap }: { lap: LapSnapshot }) {
  ...
  return (
    <section className="panel driver-panel">
      ...
      <div className="state-meta"><div><span>CONFIDENCE</span><strong>{lap.confidence}%</strong></div><div><span>EVENT TREND</span><strong className="text-orange">{lap.trend}</strong></div></div>
