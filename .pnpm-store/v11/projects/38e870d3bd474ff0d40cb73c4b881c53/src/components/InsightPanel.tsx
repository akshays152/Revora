...
export function InsightPanel({
  ...
  const status = intelligence
    ...
    : lap.trend === "RISING"
      ? "PERFORMANCE RISK INCREASING"
      : "MONITORING BASELINE";
  return (
    <section className="panel insight-panel">
      <div className="panel-heading"><span className="eyebrow">07 / AI RACE ENGINEER</span><span className="insight-spark">✦</span></div>
      <div className="insight-label"><span className="insight-pulse" /> {lap.riskLevel === "CRITICAL" ? "ACTION REQUIRED" : lap.trend === "RISING" ? "EARLY WARNING" : "MONITORING"}</div>
      ...
      <div className="insight-status"><span>STATUS</span><strong>{status}</strong></div>
